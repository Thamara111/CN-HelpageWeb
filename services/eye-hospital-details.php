...
<div class="max-w-7xl mx-auto px-4 py-12 grid grid-cols-1 lg:grid-cols-3 gap-8">
    ...
    <div class="lg:col-span-2">
        <div id="eye-hospital-container"></div>
...
$(document).ready(async function () {
    ...
    const programId = params.get("eye-hospital");

    if (!programId) {
        $("#eye-hospital-container").html(
    ...
    try {
        ...
        // Render main program
        if (program) {
            $("#eye-hospital-container").html(renderProgramHTML(program));
        } else {
            $("#eye-hospital-container").html(
