            ...
            if (donation) {
                ...
                const html = `
                    <div class="col-span-1 md:col-span-2 bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                        ...
                        <p class="text-gray-700 mb-6 text-lg leading-relaxed">${donation.description}</p>
                    </div>
                    ...
                    <div id="donate" class=" col-span-1 bg-white border-2 border-gray-100 rounded-xl p-8 shadow-lg max-w-md w-full hover:shadow-xl transition-shadow duration-300">
                        ...
                        <div class="flex flex-col space-y-4 w-full mb-6">
                            <button id="donateNowBtn"
                                class="bg-red-500 text-white font-bold text-lg px-6 py-4 rounded-xl hover:bg-red-600 transition-all duration-200 w-full text-center shadow-md hover:shadow-lg transform hover:-translate-y-0.5">
                                Donate Now
                            </button>
                            <a href="#" class="bg-gray-100 text-gray-700 font-semibold text-lg px-6 py-4 rounded-xl hover:bg-gray-200 transition-all duration-200 w-full text-center border border-gray-300 hover:border-gray-400 flex items-center justify-center space-x-2">
