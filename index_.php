            ...
            <div class="flex flex-col md:flex-row justify-between items-center mb-12">
                ...
                <div>
                    ...
                    <div class="fixed bottom-0 right-0 left-0 h-44 z-[888] bg-blur-lg backdrop-blur-md hidden">
                        ...
                        <button
                            onclick="window.location.href='/multiple-donation?donation=don1&donation=don2&donation=don3'"
    ...
    <footer class="bg-gray-900 text-white py-8">
        <div class="container mx-auto px-4 md:px-8">
            <div class="flex justify-between items-center">
                ...
                <div>
                    <a href="/terms-conditions" class="text-gray-400 hover:text-gray-200">Terms & Conditions</a>
    ...
    <script>
        $(document).ready(function () {
            ...
            $(document).on('click', '.fixed.bottom-0 button', function () {
                ...
                window.location.href = `/multiple-donation?${queryString}`;
            });
        });
    </script>
