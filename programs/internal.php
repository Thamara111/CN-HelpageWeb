...
<section class="relative h-screen flex items-center justify-center text-center text-white overflow-hidden">
    ...
    <div class="relative z-10 px-4" data-aos="fade-up" data-aos-duration="1500">
        ...
        <a href="#internal-donations-container"
    ...
    <div class="container mx-auto px-6 py-12">
        <div class="grid grid-cols-1 grid-cols-1 md:grid-cols-2 lg:gap-6">
            ...
            <div data-aos="fade-left" data-aos-duration="1500">
                <img src="/assets/images/sec-1.webp" alt="Human Resources & Internal Events" class="rounded-2xl">
            </div>
        </div>
    </div>
</section>
...
<!-- Contact Section -->
<section id="internal-donations-container" class="" data-aos="fade-up" data-aos-duration="1500">
    <div class="container mx-auto px-6 py-12">
            ...
            try {
                ...
                $.each(internalData, function (index, item) {
                    ...
                    <div class="w-1/2 flex flex-col justify-center p-6">
                        ...
                        <a href="/programs-internal-details?internal=${item.id}" class="inline-block bg-black text-white hover:bg-gray-800 py-2 px-4 rounded-2xl text-sm w-max"> 
                            View Details 
                        </a>
                    </div>
                </div>`;
